        ...
        try {
            if (mNotificationActivityClass != null) {
                ...
                String typeStart = Objects.requireNonNull(
                        mNotificationActivityClass.get("TYPE_START").get(null)).toString();
...
//PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
       ...
       // PendingIntent disconnectPendingIntent = PendingIntent.getActivity(this, 0, disconnectVPN, 0);
        ...
        if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
           ...
           // PendingIntent pauseVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                resumeVPNPending=PendingIntent.getService(this, 0, pauseVPN, PendingIntent.FLAG_MUTABLE);
            } else {
    ...
    public static String getTime() {//it will be call from mainactivity for get current status
